...
paras = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
...
for i in paras:
    ...
    outc[(0.01*i)-1] = accu
    outc_time[(0.01*i)-1] = time
pd.DataFrame(outc).to_csv("2_ly_best.csv", index=False)
pd.DataFrame(outc_time).to_csv("2_ly_best_time.csv", index=False)
